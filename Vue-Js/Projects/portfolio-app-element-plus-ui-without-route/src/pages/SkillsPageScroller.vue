<template>
    <el-container style="height: 500px; border: 1px solid #eee" class="main-container">
      ...
      <el-button v-if="skillsNavVisibility" @click="toggleSkillsBar"><font-awesome-icon :icon="['fas','cog']" /> Skills</el-button>
...
<script>
  ...
  export default {
    ...
    computed:{
        ...
        // }
        skillsNavVisibility(){
          return this.scrollPosition > 1000 && this.scrollPosition <1600 && this.isMobileView;
        }
