    ...
    createProblemObject(state){
        ...
        while(i< problem.length){
            ...
            if(problem[i].match(/[a-z]/i)){
                ...
                // console.log('configVal Text Bef',newOpd.configValue.text);
                newOpd.configValue.text = problem[i];
                // console.log('configVal Text Aft',newOpd.configValue.text);
                //change type 
                newOpd.type ='opd';
                //change val type
                newOpd.valType = 'var';
                //Update coordinates
                newOpd = Object.assign({}, setCoordinates('opd', newOpd)); 
                // newOpd.configValue.text = newOpd.val;
                // console.log('newopd-UPDATED', newOpd);
                if(i>0){
                ...
                // console.log('Coordinates set on Operator obj', newOper);
                //check for '='
                if(problem[i] === '='){
                    //Element is '='
                    //change side value
