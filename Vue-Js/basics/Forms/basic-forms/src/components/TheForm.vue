<template>
  <form @submit.prevent="submitData">
    ...
    <div class="form-control">
      ...
      <div>
        <input id="how-video" name="how" value="videos" type="radio" v-model="how" />
    ...
    <div class="form-control">
      <input type="checkbox" name="confirm-terms" value="" v-model="confirm">
      <label for="confirm-terms">Agree to Terms & Conditions</label>
    </div>
    <div class="form-control">
      <ratings-control v-model="rating" :modelValue="rating"></ratings-control>
    </div>
    <div>
...
<script>
import RatingsControl from './RatingsControl.vue';
